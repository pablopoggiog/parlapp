...
userRouter.post('/', async (req, res) => {
    try {
        const user = await controller.addUser(req.body.name, req.body.imgSrc, new Date())
...
userRouter.patch('/:id', async (req, res) => {
    try {
        ...
        const data = await controller.updateUser(req.params.id, req.body.name, req.body.imgSrc);
